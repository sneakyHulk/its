#include "camera_node_multicast.h"

#include <boost/circular_buffer.hpp>
#include <filesystem>
#include <utility>

ImageData CameraMulticast::input_function() {
	do {
...
void CameraMulticast::init_camera() {
...
CameraMulticast::CameraMulticast(std::string mac_address, std::string cam_name) : mac_adress(std::move(mac_address)), cam_name(std::move(cam_name)) { init_camera(); }

int CameraMulticast::ip_index = 1;