...
int main(int argc, char *argv[]) {
	...
	cv::VideoCapture images(std::filesystem::path(CMAKE_SOURCE_DIR) / "data" / "samples" / "12184550_1920_1080_30fps.mp4");
	...
	for (guint64 frame_count = 0, timestamp = 0;;) {
		images = cv::VideoCapture(std::filesystem::path(CMAKE_SOURCE_DIR) / "data" / "samples" / "12184550_1920_1080_30fps.mp4");
