...
#include "affine_transformation_map_origin_to_utm"
	...
	ImageUndistortionNode image_undistortion({{"s110_n_cam_8", {{1400.3096617691212, 0., 967.7899705163408, 0., 1403.041082755918, 581.7195041357244, 0., 0., 1.},
	                                                               {-0.17018194636847647, 0.12138270789030073, -0.00011663550730431874, -0.0023506235533554587, -0.030445936493878178}, 1200, 1920}},
	    {"s110_w_cam_8", {{1400.3096617691212, 0., 967.7899705163408, 0., 1403.041082755918, 581.7195041357244, 0., 0., 1.},
	                         {-0.17018194636847647, 0.12138270789030073, -0.00011663550730431874, -0.0023506235533554587, -0.030445936493878178}, 1200, 1920}},
	    {"s110_s_cam_8", {{1400.3096617691212, 0., 967.7899705163408, 0., 1403.041082755918, 581.7195041357244, 0., 0., 1.},
	...
	cams += preprocessing;
	preprocessing += image_undistortion;
	image_undistortion += down;

	// image_undistortion += vis;
	...
	std::thread image_undistortion_thread(&ImageUndistortionNode::operator(), &image_undistortion);
	...
	// std::thread vis_thread(&ImageVisualizationNode::operator(), &vis);
