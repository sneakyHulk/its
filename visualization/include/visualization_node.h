...
public:
    explicit BirdEyeVisualization(Config const& config, std::filesystem::path const& map_path = std::filesystem::path(CMAKE_SOURCE_DIR) / std::filesystem::path("data/visualization/2021-07-07_1490_Providentia_Plus_Plus_1_6.xodr"));
